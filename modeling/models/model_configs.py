...
lstm_net = {'model': RNNNet,
            'model_params': {
                    'items_path': "data/items_dense_wiki.parquet",
                    'items_categories_path': "data/items_categories_dense_wiki.parquet",
                    'shops_path': "data/shops_dense_wiki.parquet",
                    'input_features_num': 343, 'num_epochs': 5, 'batch_size': 256, "learning_rate": 1e-5,
